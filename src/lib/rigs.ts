...
export const STORE_ITEMS: StoreItem[] = [
  ...
  })),
  {
    ...
    name: "Holo Foil",
    category: "Card Skin",
    description: "Rainbow refraction sweep across the card face",
    tokens: 150,
  },
  {
    id: "skin-gold",
    name: "Legendary Gold",
    category: "Card Skin",
    description: "Gilded frame reserved for 10+ mile quests",
    tokens: 300,
  },
  {
    id: "fx-boss",
    ...
    description: "Adds a second mini-boss encounter at your halfway split",
    tokens: 200,
  },
  {
    id: "fx-crt",
    name: "CRT Bloom",
    category: "Video Effect",
    description: "Curved glass, phosphor glow and scanline flicker",
    tokens: 140,
  },
  {
    id: "fx-confetti",
    name: "Mega Fireworks",
    category: "Video Effect",
    description: "Triple-burst finale on the LEVEL COMPLETE screen",
    tokens: 90,
  },
];
