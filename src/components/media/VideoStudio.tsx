...
export function VideoStudio({ run, totalMiles }: Props) {
  ...
  }, [palette, run, totalMiles, mode, generated]);
  ...
  const saveClip = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `8bit-runner-${mode}-reel.${ext}`;
      a.click();
      setTimeout(() => URL.revokeObjectURL(url), 5000);
      playSfx("complete");
      toast.success("Reel exported to your camera roll");
    } catch {
    ...
    <div className="space-y-3">
      ...
      <div className="flex gap-2.5">
        ...
        >
          ...
          {booting ? "Rendering…" : generated ? "Generate again" : "Tap to Generate Video"}
        </button>
      </div>
      ...
      {generated && !booting && (
        ...
        >
          ...
          {exporting ? "Capturing reel…" : "Save / Export MP4"}
        </button>
      )}
